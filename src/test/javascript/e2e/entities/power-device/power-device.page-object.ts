...
export default class PowerDeviceComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('power-device-heading'));
...
export class PowerDeviceDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('deviceApp.powerDevice.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-powerDevice'));
}
